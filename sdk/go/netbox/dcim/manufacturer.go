...
func NewManufacturer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:dcim/manufacturer:Manufacturer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManufacturer(ctx *pulumi.Context,
	...
	var resource Manufacturer
	err := ctx.ReadResource("netbox:dcim/manufacturer:Manufacturer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
