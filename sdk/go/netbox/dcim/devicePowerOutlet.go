...
func (o DevicePowerOutletOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DevicePowerOutlet) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
