...
func (o PowerFeedOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *PowerFeed) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
