...
func (o PowerPanelOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *PowerPanel) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
