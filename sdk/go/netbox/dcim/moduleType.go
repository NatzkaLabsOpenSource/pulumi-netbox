...
func (o ModuleTypeOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ModuleType) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
