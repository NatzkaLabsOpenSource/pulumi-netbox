...
func (o InventoryItemOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InventoryItem) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
