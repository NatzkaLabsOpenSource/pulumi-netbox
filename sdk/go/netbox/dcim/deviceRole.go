...
func NewDeviceRole(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:dcim/deviceRole:DeviceRole", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeviceRole(ctx *pulumi.Context,
	...
	var resource DeviceRole
	err := ctx.ReadResource("netbox:dcim/deviceRole:DeviceRole", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o DeviceRoleOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DeviceRole) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}
...
func (o DeviceRoleOutput) Tags() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DeviceRole) pulumi.StringArrayOutput { return v.Tags }).(pulumi.StringArrayOutput)
}

func (o DeviceRoleOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DeviceRole) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
