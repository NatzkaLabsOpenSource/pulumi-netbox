...
func (o GetDeviceInterfacesResultOutput) Limit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetDeviceInterfacesResult) *int { return v.Limit }).(pulumi.IntPtrOutput)
}
