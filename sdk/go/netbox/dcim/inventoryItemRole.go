...
func (o InventoryItemRoleOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InventoryItemRole) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
