...
func (o DeviceConsoleServerPortOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DeviceConsoleServerPort) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
