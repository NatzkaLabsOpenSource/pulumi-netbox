...
func (o DeviceModuleBayOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DeviceModuleBay) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
