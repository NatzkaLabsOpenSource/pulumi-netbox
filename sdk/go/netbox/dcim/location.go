...
func (o LocationOutput) Facility() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Location) pulumi.StringPtrOutput { return v.Facility }).(pulumi.StringPtrOutput)
}
...
func (o LocationOutput) SiteId() pulumi.IntOutput {
	return o.ApplyT(func(v *Location) pulumi.IntOutput { return v.SiteId }).(pulumi.IntOutput)
}
...
func (o LocationOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Location) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
