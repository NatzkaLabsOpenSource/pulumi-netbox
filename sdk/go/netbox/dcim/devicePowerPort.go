...
func (o DevicePowerPortOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DevicePowerPort) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
