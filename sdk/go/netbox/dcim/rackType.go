...
func (o RackTypeOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *RackType) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
