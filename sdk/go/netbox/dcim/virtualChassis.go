...
func (o VirtualChassisOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *VirtualChassis) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
