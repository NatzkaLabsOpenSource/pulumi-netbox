...
func (o DeviceConsolePortOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *DeviceConsolePort) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
