...
func (o InterfaceOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Interface) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
