...
func NewClusterGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:virt/clusterGroup:ClusterGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterGroup(ctx *pulumi.Context,
	...
	var resource ClusterGroup
	err := ctx.ReadResource("netbox:virt/clusterGroup:ClusterGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
