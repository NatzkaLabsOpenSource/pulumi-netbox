...
func NewPrimaryIp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:virt/primaryIp:PrimaryIp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrimaryIp(ctx *pulumi.Context,
	...
	var resource PrimaryIp
	err := ctx.ReadResource("netbox:virt/primaryIp:PrimaryIp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
