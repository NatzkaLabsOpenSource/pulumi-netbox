...
func (o VirtualMachineOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *VirtualMachine) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
