...
func (o VirtualDiskOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *VirtualDisk) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
