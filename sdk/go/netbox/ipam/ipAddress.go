...
func (o IpAddressOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *IpAddress) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
