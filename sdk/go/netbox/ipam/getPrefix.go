...
func (o LookupPrefixResultOutput) LocationId() pulumi.IntOutput {
	return o.ApplyT(func(v LookupPrefixResult) int { return v.LocationId }).(pulumi.IntOutput)
}
...
func (o LookupPrefixResultOutput) RegionId() pulumi.IntOutput {
	return o.ApplyT(func(v LookupPrefixResult) int { return v.RegionId }).(pulumi.IntOutput)
}
...
func (o LookupPrefixResultOutput) SiteGroupId() pulumi.IntOutput {
	return o.ApplyT(func(v LookupPrefixResult) int { return v.SiteGroupId }).(pulumi.IntOutput)
}
