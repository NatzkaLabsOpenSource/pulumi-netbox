...
func NewAvailablePrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:ipam/availablePrefix:AvailablePrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAvailablePrefix(ctx *pulumi.Context,
	...
	var resource AvailablePrefix
	err := ctx.ReadResource("netbox:ipam/availablePrefix:AvailablePrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o AvailablePrefixOutput) CustomFields() pulumi.StringMapOutput {
	return o.ApplyT(func(v *AvailablePrefix) pulumi.StringMapOutput { return v.CustomFields }).(pulumi.StringMapOutput)
}
...
func (o AvailablePrefixOutput) LocationId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AvailablePrefix) pulumi.IntPtrOutput { return v.LocationId }).(pulumi.IntPtrOutput)
}
...
// Conflicts with `locationId`, `siteId` and `siteGroupId`.
func (o AvailablePrefixOutput) RegionId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AvailablePrefix) pulumi.IntPtrOutput { return v.RegionId }).(pulumi.IntPtrOutput)
}
...
func (o AvailablePrefixOutput) SiteGroupId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AvailablePrefix) pulumi.IntPtrOutput { return v.SiteGroupId }).(pulumi.IntPtrOutput)
}
...
func (o AvailablePrefixOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AvailablePrefix) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
