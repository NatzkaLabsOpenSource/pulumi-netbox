...
func NewPrefix(ctx *pulumi.Context,
	...
	var resource Prefix
	err := ctx.RegisterResource("netbox:ipam/prefix:Prefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefix(ctx *pulumi.Context,
	...
	var resource Prefix
	err := ctx.ReadResource("netbox:ipam/prefix:Prefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o PrefixOutput) LocationId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Prefix) pulumi.IntPtrOutput { return v.LocationId }).(pulumi.IntPtrOutput)
}
...
func (o PrefixOutput) RegionId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Prefix) pulumi.IntPtrOutput { return v.RegionId }).(pulumi.IntPtrOutput)
}
...
func (o PrefixOutput) SiteGroupId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Prefix) pulumi.IntPtrOutput { return v.SiteGroupId }).(pulumi.IntPtrOutput)
}
...
func (o PrefixOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Prefix) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
