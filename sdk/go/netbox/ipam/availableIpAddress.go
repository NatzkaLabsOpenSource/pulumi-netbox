...
func (o AvailableIpAddressOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AvailableIpAddress) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
