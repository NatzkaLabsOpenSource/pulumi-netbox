...
func NewRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.RegisterResource("netbox:ipam/role:Role", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.ReadResource("netbox:ipam/role:Role", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RoleOutput) Weight() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Role) pulumi.IntPtrOutput { return v.Weight }).(pulumi.IntPtrOutput)
}
