...
func NewAggregate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:ipam/aggregate:Aggregate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAggregate(ctx *pulumi.Context,
	...
	var resource Aggregate
	err := ctx.ReadResource("netbox:ipam/aggregate:Aggregate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o AggregateOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Aggregate) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
