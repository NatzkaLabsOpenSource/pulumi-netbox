...
type CircuitTermination struct {
	...
	// Exactly one of `siteId`, `siteGroupId`, `regionId` or `providerNetworkId` must be given.
	LocationId pulumi.IntPtrOutput `pulumi:"locationId"`
	PortSpeed  pulumi.IntPtrOutput `pulumi:"portSpeed"`
	// Exactly one of `locationId`, `siteId`, `siteGroupId` or `regionId` must be given.
	ProviderNetworkId pulumi.IntPtrOutput `pulumi:"providerNetworkId"`
	// Exactly one of `locationId`, `siteId`, `siteGroupId` or `providerNetworkId` must be given.
	RegionId pulumi.IntPtrOutput `pulumi:"regionId"`
	// Exactly one of `locationId`, `siteId`, `regionId` or `providerNetworkId` must be given.
	SiteGroupId pulumi.IntPtrOutput `pulumi:"siteGroupId"`
	// Exactly one of `locationId`, `siteGroupId`, `regionId` or `providerNetworkId` must be given.
...
type circuitTerminationState struct {
	...
	// Exactly one of `locationId`, `siteId`, `siteGroupId` or `regionId` must be given.
	ProviderNetworkId *int `pulumi:"providerNetworkId"`
	// Exactly one of `locationId`, `siteId`, `siteGroupId` or `providerNetworkId` must be given.
...
type CircuitTerminationState struct {
	...
	// Exactly one of `locationId`, `siteId`, `siteGroupId` or `regionId` must be given.
	ProviderNetworkId pulumi.IntPtrInput
	// Exactly one of `locationId`, `siteId`, `siteGroupId` or `providerNetworkId` must be given.
...
// Exactly one of `siteId`, `siteGroupId`, `regionId` or `providerNetworkId` must be given.
func (o CircuitTerminationOutput) LocationId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CircuitTermination) pulumi.IntPtrOutput { return v.LocationId }).(pulumi.IntPtrOutput)
}
...
// Exactly one of `locationId`, `siteId`, `siteGroupId` or `regionId` must be given.
func (o CircuitTerminationOutput) ProviderNetworkId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CircuitTermination) pulumi.IntPtrOutput { return v.ProviderNetworkId }).(pulumi.IntPtrOutput)
}

// Exactly one of `locationId`, `siteId`, `siteGroupId` or `providerNetworkId` must be given.
func (o CircuitTerminationOutput) RegionId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CircuitTermination) pulumi.IntPtrOutput { return v.RegionId }).(pulumi.IntPtrOutput)
}

// Exactly one of `locationId`, `siteId`, `regionId` or `providerNetworkId` must be given.
func (o CircuitTerminationOutput) SiteGroupId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CircuitTermination) pulumi.IntPtrOutput { return v.SiteGroupId }).(pulumi.IntPtrOutput)
}

// Exactly one of `locationId`, `siteGroupId`, `regionId` or `providerNetworkId` must be given.
func (o CircuitTerminationOutput) SiteId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CircuitTermination) pulumi.IntPtrOutput { return v.SiteId }).(pulumi.IntPtrOutput)
}
...
func (o CircuitTerminationOutput) TagsAlls() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *CircuitTermination) pulumi.StringArrayOutput { return v.TagsAlls }).(pulumi.StringArrayOutput)
}
