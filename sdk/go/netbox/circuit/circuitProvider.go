...
func NewCircuitProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:circuit/circuitProvider:CircuitProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCircuitProvider(ctx *pulumi.Context,
	...
	var resource CircuitProvider
	err := ctx.ReadResource("netbox:circuit/circuitProvider:CircuitProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
