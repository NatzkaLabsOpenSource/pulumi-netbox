...
func NewCircuit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:circuit/circuit:Circuit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCircuit(ctx *pulumi.Context,
	...
	var resource Circuit
	err := ctx.ReadResource("netbox:circuit/circuit:Circuit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
