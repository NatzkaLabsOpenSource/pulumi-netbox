...
func NewCircuitType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:circuit/circuitType:CircuitType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCircuitType(ctx *pulumi.Context,
	...
	var resource CircuitType
	err := ctx.ReadResource("netbox:circuit/circuitType:CircuitType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
