...
type customFieldState struct {
	ChoiceSetId       *int     `pulumi:"choiceSetId"`
...
func (o CustomFieldOutput) ChoiceSetId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CustomField) pulumi.IntPtrOutput { return v.ChoiceSetId }).(pulumi.IntPtrOutput)
}
...
func (o CustomFieldOutput) GroupName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CustomField) pulumi.StringPtrOutput { return v.GroupName }).(pulumi.StringPtrOutput)
}
