...
@pulumi.type_token("netbox:dcim/inventoryItemRole:InventoryItemRole")
class InventoryItemRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_inventory_item_role = netbox.dcim.InventoryItemRole("test",
            name="Role 1",
            slug="role-1-slug",
            color_hex="123456")
    ...
    def _internal_init(__self__,
        ...
        super(InventoryItemRole, __self__).__init__(
            'netbox:dcim/inventoryItemRole:InventoryItemRole',
            resource_name,
            __props__,
            opts)
