...
class InterfaceTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] device_type_id: Exactly one of `device_type_id` or `module_type_id` must be given.
        :param pulumi.Input[_builtins.int] module_type_id: Exactly one of `device_type_id` or `module_type_id` must be given.
        """
...
@pulumi.type_token("netbox:dcim/interfaceTemplate:InterfaceTemplate")
class InterfaceTemplate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="deviceTypeId")
    def device_type_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Exactly one of `device_type_id` or `module_type_id` must be given.
        """
        return pulumi.get(self, "device_type_id")
    ...
    @_builtins.property
    @pulumi.getter(name="moduleTypeId")
    def module_type_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Exactly one of `device_type_id` or `module_type_id` must be given.
        """
        return pulumi.get(self, "module_type_id")
