...
@pulumi.type_token("netbox:dcim/manufacturer:Manufacturer")
class Manufacturer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = netbox.dcim.Manufacturer("test", name="testmanufacturer")
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Manufacturer, __self__).__init__(
            'netbox:dcim/manufacturer:Manufacturer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            slug: Optional[pulumi.Input[_builtins.str]] = None) -> 'Manufacturer':
        """
