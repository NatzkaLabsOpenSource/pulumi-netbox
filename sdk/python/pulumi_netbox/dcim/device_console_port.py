...
@pulumi.type_token("netbox:dcim/deviceConsolePort:DeviceConsolePort")
class DeviceConsolePort(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_device_console_port = netbox.dcim.DeviceConsolePort("test",
            device_id=test.id,
            name="console port",
            type="de-9",
            speed=1200,
    ...
    def _internal_init(__self__,
        ...
        super(DeviceConsolePort, __self__).__init__(
            'netbox:dcim/deviceConsolePort:DeviceConsolePort',
            resource_name,
            __props__,
            opts)
