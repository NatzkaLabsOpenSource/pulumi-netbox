...
class ModuleTypeArgs:
    def __init__(__self__, *,
                 manufacturer_id: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.str] weight_unit: One of [kg, g, lb, oz]. Required when `weight` is set.
        """
    ...
    def manufacturer_id(self) -> pulumi.Input[_builtins.int]:
        return pulumi.get(self, "manufacturer_id")

    @manufacturer_id.setter
    def manufacturer_id(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("netbox:dcim/moduleType:ModuleType")
class ModuleType(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = netbox.dcim.Manufacturer("test", name="Dell")
    ...
    def _internal_init(__self__,
        ...
        super(ModuleType, __self__).__init__(
            'netbox:dcim/moduleType:ModuleType',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter(name="manufacturerId")
    def manufacturer_id(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "manufacturer_id")
