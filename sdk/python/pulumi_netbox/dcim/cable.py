...
class CableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] length_unit: One of [km, m, cm, mi, ft, in]. Required when `length` is set.
...
@pulumi.type_token("netbox:dcim/cable:Cable")
