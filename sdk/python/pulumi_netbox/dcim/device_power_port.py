...
class DevicePowerPortArgs:
    def __init__(__self__, *,
                 ...
                 allocated_draw: Optional[pulumi.Input[_builtins.int]] = None,
                 ...
                 maximum_draw: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def allocated_draw(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "allocated_draw")

    @allocated_draw.setter
    def allocated_draw(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def maximum_draw(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "maximum_draw")

    @maximum_draw.setter
    def maximum_draw(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("netbox:dcim/devicePowerPort:DevicePowerPort")
class DevicePowerPort(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_device_power_port = netbox.dcim.DevicePowerPort("test",
            device_id=test.id,
            name="power port",
            maximum_draw=750,
            allocated_draw=500,
    ...
    def _internal_init(__self__,
        ...
        super(DevicePowerPort, __self__).__init__(
            'netbox:dcim/devicePowerPort:DevicePowerPort',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter(name="allocatedDraw")
    def allocated_draw(self) -> pulumi.Output[Optional[_builtins.int]]:
        return pulumi.get(self, "allocated_draw")
    ...
    @_builtins.property
    @pulumi.getter(name="maximumDraw")
    def maximum_draw(self) -> pulumi.Output[Optional[_builtins.int]]:
        return pulumi.get(self, "maximum_draw")
