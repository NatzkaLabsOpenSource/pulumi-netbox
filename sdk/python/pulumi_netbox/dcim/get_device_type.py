...
def get_device_type(manufacturer: Optional[_builtins.str] = None,
    ...
    ex1 = netbox.dcim.get_device_type(model="7210 SAS-Sx 10/100GE")
    # Get device type by slug
    ex2 = netbox.dcim.get_device_type(slug="7210-sas-sx-10-100GE")
    # Get device type by manufacturer and part number information
    ex3 = netbox.dcim.get_device_type(manufacturer="Nokia",
    ...
    __ret__ = pulumi.runtime.invoke('netbox:dcim/getDeviceType:getDeviceType', __args__, opts=opts, typ=GetDeviceTypeResult).value
...
def get_device_type_output(manufacturer: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:dcim/getDeviceType:getDeviceType', __args__, opts=opts, typ=GetDeviceTypeResult)
