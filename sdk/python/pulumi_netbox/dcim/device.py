...
class DeviceArgs:
    def __init__(__self__, *,
                 ...
                 config_template_id: Optional[pulumi.Input[int]] = None,
    ...
    def config_template_id(self) -> Optional[pulumi.Input[int]]:
        return pulumi.get(self, "config_template_id")

    @config_template_id.setter
    def config_template_id(self, value: Optional[pulumi.Input[int]]):
...
class Device(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="configTemplateId")
    def config_template_id(self) -> pulumi.Output[Optional[int]]:
        return pulumi.get(self, "config_template_id")
