...
class GetSiteResult:
    ...
    def asn_ids(self) -> Sequence[_builtins.int]:
...
def get_site(facility: Optional[_builtins.str] = None,
    ...
    get_by_name = netbox.dcim.get_site(name="Example Site 1")
    get_by_slug = netbox.dcim.get_site(slug="example-site-1")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('netbox:dcim/getSite:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(facility: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:dcim/getSite:getSite', __args__, opts=opts, typ=GetSiteResult)
