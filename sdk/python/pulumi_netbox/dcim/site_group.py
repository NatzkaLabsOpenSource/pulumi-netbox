...
@pulumi.type_token("netbox:dcim/siteGroup:SiteGroup")
class SiteGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        parent = netbox.dcim.SiteGroup("parent",
            name="parent",
            description="sample description")
        child = netbox.dcim.SiteGroup("child",
            name="child",
            description="sample description",
            parent_id=parent.id)
        ```
    ...
    def _internal_init(__self__,
        ...
        super(SiteGroup, __self__).__init__(
            'netbox:dcim/siteGroup:SiteGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            parent_id: Optional[pulumi.Input[_builtins.int]] = None,
            slug: Optional[pulumi.Input[_builtins.str]] = None) -> 'SiteGroup':
        """
