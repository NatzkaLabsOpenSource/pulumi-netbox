...
class DeviceRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] vm_role: Defaults to `true`.
        """
...
@pulumi.type_token("netbox:dcim/deviceRole:DeviceRole")
class DeviceRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        core_sw = netbox.dcim.DeviceRole("core_sw",
            color_hex="FF00FF",
            name="core-sw")
        ```
    ...
    def _internal_init(__self__,
        ...
        super(DeviceRole, __self__).__init__(
            'netbox:dcim/deviceRole:DeviceRole',
            resource_name,
            __props__,
            opts)
