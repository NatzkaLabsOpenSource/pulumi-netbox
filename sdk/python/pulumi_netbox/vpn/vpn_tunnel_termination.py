...
class VpnTunnelTerminationArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_id: pulumi.Input[_builtins.int],
                 device_interface_id: Optional[pulumi.Input[_builtins.int]] = None,
                 outside_ip_address_id: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] role: Valid values are `peer`, `hub` and `spoke`.
        :param pulumi.Input[_builtins.int] device_interface_id: Exactly one of `virtual_machine_interface_id` or `device_interface_id` must be given.
        :param pulumi.Input[_builtins.int] virtual_machine_interface_id: Exactly one of `virtual_machine_interface_id` or `device_interface_id` must be given.
        """
    ...
    def tunnel_id(self) -> pulumi.Input[_builtins.int]:
        return pulumi.get(self, "tunnel_id")

    @tunnel_id.setter
    def tunnel_id(self, value: pulumi.Input[_builtins.int]):
    ...
    def outside_ip_address_id(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "outside_ip_address_id")

    @outside_ip_address_id.setter
    def outside_ip_address_id(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("netbox:vpn/vpnTunnelTermination:VpnTunnelTermination")
class VpnTunnelTermination(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = netbox.vpn.VpnTunnelGroup("test",
            name="my-tunnel-group",
            description="description")
        test_vpn_tunnel = netbox.vpn.VpnTunnel("test",
            name="my-tunnel",
            encapsulation="ipsec-transport",
            status="active",
            tunnel_group_id=test.id)
        device = netbox.vpn.VpnTunnelTermination("device",
            role="peer",
            tunnel_id=test_vpn_tunnel.id,
            device_interface_id=123)
        vm = netbox.vpn.VpnTunnelTermination("vm",
            role="peer",
            tunnel_id=test_vpn_tunnel.id,
    ...
    def _internal_init(__self__,
        ...
        super(VpnTunnelTermination, __self__).__init__(
            'netbox:vpn/vpnTunnelTermination:VpnTunnelTermination',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tags_alls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tunnel_id: Optional[pulumi.Input[_builtins.int]] = None,
            virtual_machine_interface_id: Optional[pulumi.Input[_builtins.int]] = None) -> 'VpnTunnelTermination':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="outsideIpAddressId")
    def outside_ip_address_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        return pulumi.get(self, "outside_ip_address_id")
