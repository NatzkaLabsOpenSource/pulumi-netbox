...
def get_virtual_machines(filters: Optional[Sequence[Union['GetVirtualMachinesFilterArgs', 'GetVirtualMachinesFilterArgsDict']]] = None,
    ...
    base_vm = netbox.virt.get_virtual_machines(name_regex="myvm-1",
        filters=[{
            "name": "cluster_id",
    ...
    __ret__ = pulumi.runtime.invoke('netbox:virt/getVirtualMachines:getVirtualMachines', __args__, opts=opts, typ=GetVirtualMachinesResult).value
...
def get_virtual_machines_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetVirtualMachinesFilterArgs', 'GetVirtualMachinesFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:virt/getVirtualMachines:getVirtualMachines', __args__, opts=opts, typ=GetVirtualMachinesResult)
