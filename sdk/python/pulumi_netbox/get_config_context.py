...
class GetConfigContextResult:
    ...
    def device_types(self) -> Sequence[int]:
    ...
    @property
    @pulumi.getter
    def locations(self) -> Sequence[int]:
    ...
    @property
    @pulumi.getter
    def platforms(self) -> Sequence[int]:
    ...
    @property
    @pulumi.getter
    def roles(self) -> Sequence[int]:
        return pulumi.get(self, "roles")

    @property
    @pulumi.getter(name="siteGroups")
    def site_groups(self) -> Sequence[int]:
        return pulumi.get(self, "site_groups")

    @property
    @pulumi.getter
    def sites(self) -> Sequence[int]:
    ...
    def tenant_groups(self) -> Sequence[int]:
        return pulumi.get(self, "tenant_groups")

    @property
    @pulumi.getter
    def tenants(self) -> Sequence[int]:
...
def get_config_context(name: Optional[str] = None,
...
def get_config_context_output(name: Optional[pulumi.Input[str]] = None,
