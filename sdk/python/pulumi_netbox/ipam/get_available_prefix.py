...
class GetAvailablePrefixResult:
    ...
    def prefix_id(self) -> _builtins.int:
...
def get_available_prefix(prefix_id: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:ipam/getAvailablePrefix:getAvailablePrefix', __args__, opts=opts, typ=GetAvailablePrefixResult).value
...
def get_available_prefix_output(prefix_id: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:ipam/getAvailablePrefix:getAvailablePrefix', __args__, opts=opts, typ=GetAvailablePrefixResult)
