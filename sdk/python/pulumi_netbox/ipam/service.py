...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] protocol: Valid values are `tcp`, `udp` and `sctp`.
        :param pulumi.Input[int] device_id: Exactly one of `virtual_machine_id` or `device_id` must be given.
        :param pulumi.Input[int] port: Exactly one of `port` or `ports` must be given.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] ports: Exactly one of `port` or `ports` must be given.
        :param pulumi.Input[int] virtual_machine_id: Exactly one of `virtual_machine_id` or `device_id` must be given.
        """
...
class Service(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="virtualMachineId")
    def virtual_machine_id(self) -> pulumi.Output[Optional[int]]:
        """
        Exactly one of `virtual_machine_id` or `device_id` must be given.
        """
        return pulumi.get(self, "virtual_machine_id")
