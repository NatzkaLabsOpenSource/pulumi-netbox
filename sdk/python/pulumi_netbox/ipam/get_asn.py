...
def get_asn(asn: Optional[_builtins.str] = None,
    ...
    asn1 = netbox.ipam.get_asn(asn="1111",
        tag="tag-1")
    asn2 = netbox.ipam.get_asn(tag="tag-1",
        tag_n="tag-2")
    ```


    :param _builtins.str asn: At least one of `asn` or `tag` must be given.
    :param _builtins.str tag: Tag to include in the data source filter (must match the tag's slug). At least one of `asn` or `tag` must be given.
    ...
    __ret__ = pulumi.runtime.invoke('netbox:ipam/getAsn:getAsn', __args__, opts=opts, typ=GetAsnResult).value
...
def get_asn_output(asn: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:ipam/getAsn:getAsn', __args__, opts=opts, typ=GetAsnResult)
