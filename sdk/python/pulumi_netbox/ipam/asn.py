...
class AsnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] asn: Value for the AS Number record.
        :param pulumi.Input[int] rir_id: ID for the RIR for the AS Number record.
        :param pulumi.Input[str] comments: Comments field for the AS Number record.
        :param pulumi.Input[str] description: Description field for the AS Number record.
        """
