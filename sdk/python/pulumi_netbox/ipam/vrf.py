...
class VrfArgs:
    def __init__(__self__, *,
                 ...
                 enforce_unique: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] enforce_unique: Defaults to `true`.
        """
    ...
    def enforce_unique(self) -> Optional[pulumi.Input[bool]]:
        """
        Defaults to `true`.
        """
    ...
    def enforce_unique(self, value: Optional[pulumi.Input[bool]]):
...
class Vrf(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enforceUnique")
    def enforce_unique(self) -> pulumi.Output[Optional[bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "enforce_unique")
