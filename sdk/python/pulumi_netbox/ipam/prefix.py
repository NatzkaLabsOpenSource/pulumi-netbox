...
@pulumi.type_token("netbox:ipam/prefix:Prefix")
class Prefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        my_prefix = netbox.ipam.Prefix("my_prefix",
            prefix="10.0.0.0/24",
            status="active",
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[_builtins.int]] = None,
            vlan_id: Optional[pulumi.Input[_builtins.int]] = None,
            vrf_id: Optional[pulumi.Input[_builtins.int]] = None) -> 'Prefix':
        """
