...
class VlanArgs:
    def __init__(__self__, *,
                 vid: pulumi.Input[_builtins.int],
    ...
    @_builtins.property
    @pulumi.getter
    def vid(self) -> pulumi.Input[_builtins.int]:
        return pulumi.get(self, "vid")

    @vid.setter
    def vid(self, value: pulumi.Input[_builtins.int]):
...
class _VlanState:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[_builtins.int]] = None,
                 vid: Optional[pulumi.Input[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def vid(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "vid")

    @vid.setter
    def vid(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "vid", value)


@pulumi.type_token("netbox:ipam/vlan:Vlan")
class Vlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example1 = netbox.ipam.Vlan("example1",
            name="VLAN 1",
            vid=1777,
            tags=[])
        # Assume netbox_tenant, netbox_site, and netbox_tag resources exist
        example2 = netbox.ipam.Vlan("example2",
            name="VLAN 2",
            vid=1778,
            status="reserved",
    ...
    def get(resource_name: str,
            ...
            tags_alls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tenant_id: Optional[pulumi.Input[_builtins.int]] = None,
            vid: Optional[pulumi.Input[_builtins.int]] = None) -> 'Vlan':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def vid(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "vid")
