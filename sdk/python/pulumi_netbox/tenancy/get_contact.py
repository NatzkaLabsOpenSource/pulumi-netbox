...
def get_contact(description: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:tenancy/getContact:getContact', __args__, opts=opts, typ=GetContactResult).value
...
def get_contact_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:tenancy/getContact:getContact', __args__, opts=opts, typ=GetContactResult)
