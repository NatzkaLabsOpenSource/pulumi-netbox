...
class ContactAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] priority: Valid values are `primary`, `secondary`, `tertiary` and `inactive`.
        """
...
@pulumi.type_token("netbox:tenancy/contactAssignment:ContactAssignment")
class ContactAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = netbox.tenancy.Contact("test", name="test")
        test_contact_role = netbox.tenancy.ContactRole("test", name="test")
        # Assumes that a device with id 123 exists
        test_contact_assignment = netbox.tenancy.ContactAssignment("test",
    ...
    def _internal_init(__self__,
        ...
        super(ContactAssignment, __self__).__init__(
            'netbox:tenancy/contactAssignment:ContactAssignment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            object_id: Optional[pulumi.Input[_builtins.int]] = None,
            priority: Optional[pulumi.Input[_builtins.str]] = None,
            role_id: Optional[pulumi.Input[_builtins.int]] = None) -> 'ContactAssignment':
        """
