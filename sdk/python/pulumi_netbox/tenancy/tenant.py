...
@pulumi.type_token("netbox:tenancy/tenant:Tenant")
class Tenant(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        customer_a = netbox.tenancy.Tenant("customer_a", name="Customer A")
        ```
    ...
    def get(resource_name: str,
            ...
            slug: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tags_alls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'Tenant':
        """
