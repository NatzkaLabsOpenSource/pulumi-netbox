...
def get_contact_group(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:tenancy/getContactGroup:getContactGroup', __args__, opts=opts, typ=GetContactGroupResult).value
...
def get_contact_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:tenancy/getContactGroup:getContactGroup', __args__, opts=opts, typ=GetContactGroupResult)
