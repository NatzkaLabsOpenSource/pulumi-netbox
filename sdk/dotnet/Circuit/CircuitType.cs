...
namespace Pulumi.Netbox.Circuit
{
    ...
    /// {
    ///     var test = new Netbox.Circuit.CircuitType("test", new()
    ///     {
    ///         Name = "test",
    ///     });
    /// 
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:circuit/circuitType:CircuitType")]
    public partial class CircuitType : global::Pulumi.CustomResource
    {
        ...
        public CircuitType(string name, CircuitTypeArgs? args = null, CustomResourceOptions? options = null)
            : base("netbox:circuit/circuitType:CircuitType", name, args ?? new CircuitTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CircuitType(string name, Input<string> id, CircuitTypeState? state = null, CustomResourceOptions? options = null)
            : base("netbox:circuit/circuitType:CircuitType", name, state, MakeResourceOptions(options, id))
        {
        }
