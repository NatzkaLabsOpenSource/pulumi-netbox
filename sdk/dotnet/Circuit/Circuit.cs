...
namespace Pulumi.Netbox.Circuit
{
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:circuit/circuit:Circuit")]
    public partial class Circuit : global::Pulumi.CustomResource
    {
        ...
        public Circuit(string name, CircuitArgs args, CustomResourceOptions? options = null)
            : base("netbox:circuit/circuit:Circuit", name, args ?? new CircuitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Circuit(string name, Input<string> id, CircuitState? state = null, CustomResourceOptions? options = null)
            : base("netbox:circuit/circuit:Circuit", name, state, MakeResourceOptions(options, id))
        {
        }
