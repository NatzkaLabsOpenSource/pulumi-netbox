...
namespace Pulumi.Netbox.Virt
{
    ...
    /// </summary>
    [NetboxResourceType("netbox:virt/primaryIp:PrimaryIp")]
    public partial class PrimaryIp : global::Pulumi.CustomResource
    {
        ...
        public PrimaryIp(string name, PrimaryIpArgs args, CustomResourceOptions? options = null)
            : base("netbox:virt/primaryIp:PrimaryIp", name, args ?? new PrimaryIpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrimaryIp(string name, Input<string> id, PrimaryIpState? state = null, CustomResourceOptions? options = null)
            : base("netbox:virt/primaryIp:PrimaryIp", name, state, MakeResourceOptions(options, id))
        {
        }
