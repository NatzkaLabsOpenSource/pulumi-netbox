...
namespace Pulumi.Netbox.Virt
{
    ...
    /// </summary>
    [NetboxResourceType("netbox:virt/interface:Interface")]
    public partial class Interface : global::Pulumi.CustomResource
    {
        ...
        public Interface(string name, InterfaceArgs args, CustomResourceOptions? options = null)
            : base("netbox:virt/interface:Interface", name, args ?? new InterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Interface(string name, Input<string> id, InterfaceState? state = null, CustomResourceOptions? options = null)
            : base("netbox:virt/interface:Interface", name, state, MakeResourceOptions(options, id))
        {
        }
