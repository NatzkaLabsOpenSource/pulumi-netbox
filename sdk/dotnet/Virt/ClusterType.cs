...
namespace Pulumi.Netbox.Virt
{
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:virt/clusterType:ClusterType")]
    public partial class ClusterType : global::Pulumi.CustomResource
    {
        ...
        public ClusterType(string name, ClusterTypeArgs? args = null, CustomResourceOptions? options = null)
            : base("netbox:virt/clusterType:ClusterType", name, args ?? new ClusterTypeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterType(string name, Input<string> id, ClusterTypeState? state = null, CustomResourceOptions? options = null)
            : base("netbox:virt/clusterType:ClusterType", name, state, MakeResourceOptions(options, id))
        {
        }
