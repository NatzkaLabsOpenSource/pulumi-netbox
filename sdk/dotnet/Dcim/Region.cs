...
namespace Pulumi.Netbox.Dcim
{
    ...
    /// {
    ///     var test = new Netbox.Dcim.Region("test", new()
    ///     {
    ///         Name = "test",
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:dcim/region:Region")]
    public partial class Region : global::Pulumi.CustomResource
    {
        ...
        public Region(string name, RegionArgs? args = null, CustomResourceOptions? options = null)
            : base("netbox:dcim/region:Region", name, args ?? new RegionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Region(string name, Input<string> id, RegionState? state = null, CustomResourceOptions? options = null)
            : base("netbox:dcim/region:Region", name, state, MakeResourceOptions(options, id))
        {
        }
