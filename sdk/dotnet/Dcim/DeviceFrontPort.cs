...
namespace Pulumi.Netbox.Dcim
{
    ...
    ///     });
    /// 
    ///     var testDeviceFrontPort = new Netbox.Dcim.DeviceFrontPort("test", new()
    ///     {
    ///         DeviceId = test.Id,
    ///         Name = "front port 1",
    ///         Type = "8p8c",
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:dcim/deviceFrontPort:DeviceFrontPort")]
    public partial class DeviceFrontPort : global::Pulumi.CustomResource
    {
        [Output("colorHex")]
        ...
        [Output("rearPortId")]
        public Output<int> RearPortId { get; private set; } = null!;

        [Output("rearPortPosition")]
        public Output<int> RearPortPosition { get; private set; } = null!;
        ...
        public DeviceFrontPort(string name, DeviceFrontPortArgs args, CustomResourceOptions? options = null)
            : base("netbox:dcim/deviceFrontPort:DeviceFrontPort", name, args ?? new DeviceFrontPortArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeviceFrontPort(string name, Input<string> id, DeviceFrontPortState? state = null, CustomResourceOptions? options = null)
            : base("netbox:dcim/deviceFrontPort:DeviceFrontPort", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DeviceFrontPort Get(string name, Input<string> id, DeviceFrontPortState? state = null, CustomResourceOptions? options = null)
        {
            return new DeviceFrontPort(name, id, state, options);
        }
    }

    public sealed class DeviceFrontPortArgs : global::Pulumi.ResourceArgs
    {
        [Input("colorHex")]
        ...
        [Input("rearPortId", required: true)]
        public Input<int> RearPortId { get; set; } = null!;

        [Input("rearPortPosition", required: true)]
        public Input<int> RearPortPosition { get; set; } = null!;
        ...
        public DeviceFrontPortArgs()
        {
        }
        public static new DeviceFrontPortArgs Empty => new DeviceFrontPortArgs();
    }

    public sealed class DeviceFrontPortState : global::Pulumi.ResourceArgs
    {
        [Input("colorHex")]
        public Input<string>? ColorHex { get; set; }
        ...
        [Input("rearPortId")]
        public Input<int>? RearPortId { get; set; }

        [Input("rearPortPosition")]
        public Input<int>? RearPortPosition { get; set; }
        ...
        public DeviceFrontPortState()
        {
        }
        public static new DeviceFrontPortState Empty => new DeviceFrontPortState();
    }
}
