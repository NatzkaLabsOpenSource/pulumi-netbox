...
namespace Pulumi.Netbox.Ipam
{
    ...
    /// {
    ///     var custAProd = new Netbox.Ipam.Vrf("cust_a_prod", new()
    ///     {
    ///         Name = "cust-a-prod",
    ///         Tags = new[]
    ///         {
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:ipam/vrf:Vrf")]
    public partial class Vrf : global::Pulumi.CustomResource
    {
        ...
        /// Defaults to `true`.
        /// </summary>
        [Output("enforceUnique")]
        public Output<bool?> EnforceUnique { get; private set; } = null!;
        ...
        public Vrf(string name, VrfArgs? args = null, CustomResourceOptions? options = null)
            : base("netbox:ipam/vrf:Vrf", name, args ?? new VrfArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vrf(string name, Input<string> id, VrfState? state = null, CustomResourceOptions? options = null)
            : base("netbox:ipam/vrf:Vrf", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VrfArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("enforceUnique")]
        public Input<bool>? EnforceUnique { get; set; }
