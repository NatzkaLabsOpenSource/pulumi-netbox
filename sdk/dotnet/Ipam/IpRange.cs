...
namespace Pulumi.Netbox.Ipam
{
    ...
    /// {
    ///     var custAProd = new Netbox.Ipam.IpRange("cust_a_prod", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:ipam/ipRange:IpRange")]
    public partial class IpRange : global::Pulumi.CustomResource
    {
        ...
        public IpRange(string name, IpRangeArgs args, CustomResourceOptions? options = null)
            : base("netbox:ipam/ipRange:IpRange", name, args ?? new IpRangeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpRange(string name, Input<string> id, IpRangeState? state = null, CustomResourceOptions? options = null)
            : base("netbox:ipam/ipRange:IpRange", name, state, MakeResourceOptions(options, id))
        {
        }
