...
namespace Pulumi.Netbox.Ipam
{
    ...
    ///     });
    /// 
    ///     var testAvailablePrefix = new Netbox.Ipam.AvailablePrefix("test", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:ipam/availablePrefix:AvailablePrefix")]
    public partial class AvailablePrefix : global::Pulumi.CustomResource
    {
        ...
        public AvailablePrefix(string name, AvailablePrefixArgs args, CustomResourceOptions? options = null)
            : base("netbox:ipam/availablePrefix:AvailablePrefix", name, args ?? new AvailablePrefixArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AvailablePrefix(string name, Input<string> id, AvailablePrefixState? state = null, CustomResourceOptions? options = null)
            : base("netbox:ipam/availablePrefix:AvailablePrefix", name, state, MakeResourceOptions(options, id))
        {
        }
