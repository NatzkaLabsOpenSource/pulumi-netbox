...
namespace Pulumi.Netbox.Ipam
{
    ...
    ///     });
    /// 
    ///     var testAggregate = new Netbox.Ipam.Aggregate("test", new()
    ///     {
    ///         Prefix = "1.1.1.0/25",
    ...
    /// ```
    /// </summary>
    [NetboxResourceType("netbox:ipam/aggregate:Aggregate")]
    public partial class Aggregate : global::Pulumi.CustomResource
    {
        ...
        public Aggregate(string name, AggregateArgs args, CustomResourceOptions? options = null)
            : base("netbox:ipam/aggregate:Aggregate", name, args ?? new AggregateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Aggregate(string name, Input<string> id, AggregateState? state = null, CustomResourceOptions? options = null)
            : base("netbox:ipam/aggregate:Aggregate", name, state, MakeResourceOptions(options, id))
        {
        }
