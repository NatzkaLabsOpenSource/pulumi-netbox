 ...
 * });
 * const testDeviceConsolePort = new netbox.dcim.DeviceConsolePort("testDeviceConsolePort", {
 ...
 * ```
 */
export class DeviceConsolePort extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceConsolePortState, opts?: pulumi.CustomResourceOptions): DeviceConsolePort {
        return new DeviceConsolePort(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'netbox:dcim/deviceConsolePort:DeviceConsolePort';

    /**
     * Returns true if the given object is an instance of DeviceConsolePort.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceConsolePort {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceConsolePort.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DeviceConsolePortArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceConsolePortArgs | DeviceConsolePortState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceConsolePortState | undefined;
            ...
            const args = argsOrState as DeviceConsolePortArgs | undefined;
        ...
        super(DeviceConsolePort.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DeviceConsolePortState {
 ...
 */
export interface DeviceConsolePortArgs {
    customFields?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    description?: pulumi.Input<string>;
    deviceId: pulumi.Input<number>;
    label?: pulumi.Input<string>;
