 ...
 *     name: "vmw-cluster-01",
 * });
 * const baseVm = new netbox.virt.VirtualMachine("base_vm", {
 *     clusterId: vmwCluster01.then(vmwCluster01 => vmwCluster01.id),
 *     name: "myvm-1",
 * });
 * const example = new netbox.virt.VirtualDisk("example", {
 *     name: "disk-01",
...
export class VirtualDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'netbox:virt/virtualDisk:VirtualDisk';
    ...
    public readonly sizeMb!: pulumi.Output<number>;
    ...
    constructor(name: string, argsOrState?: VirtualDiskArgs | VirtualDiskState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sizeMb"] = state ? state.sizeMb : undefined;
            ...
            if ((!args || args.sizeMb === undefined) && !opts.urn) {
                throw new Error("Missing required property 'sizeMb'");
            }
            ...
            resourceInputs["sizeMb"] = args ? args.sizeMb : undefined;
