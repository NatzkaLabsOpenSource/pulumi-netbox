...
export interface GetDevicePowerPortsPowerPort {
...
export interface GetIpRangesIpRange {
    ...
    startAddress: string;
    status: string;
    tags: outputs.GetIpRangesIpRangeTag[];
    tenants: outputs.GetIpRangesIpRangeTenant[];
}

export interface GetIpRangesIpRangeTag {
    display: string;
    id: number;
    name: string;
    slug: string;
...
export interface GetIpRangesIpRangeTenant {
    id: number;
    name: string;
    slug: string;
}
...
export interface GetVirtualDiskVirtualDisk {
    customFields: {[key: string]: string};
    description: string;
    id: number;
    name: string;
...
export namespace dcim {
    ...
    export interface GetDeviceInterfacesInterface {
         ...
         */
        macAddress: string;
        macAddresses: outputs.dcim.GetDeviceInterfacesInterfaceMacAddress[];
    ...
    export interface GetDeviceInterfacesInterfaceMacAddress {
        description: string;
        id: number;
        macAddress: string;
    }
