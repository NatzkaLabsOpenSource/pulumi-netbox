...
export class CircuitTermination extends pulumi.CustomResource {
     ...
     */
    public readonly providerNetworkId!: pulumi.Output<number | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CircuitTerminationArgs | CircuitTerminationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["providerNetworkId"] = state ? state.providerNetworkId : undefined;
            ...
            resourceInputs["providerNetworkId"] = args ? args.providerNetworkId : undefined;
...
export interface CircuitTerminationState {
     ...
     * Exactly one of `locationId`, `siteId`, `siteGroupId` or `regionId` must be given.
     */
    providerNetworkId?: pulumi.Input<number>;
    /**
     * Exactly one of `locationId`, `siteId`, `siteGroupId` or `providerNetworkId` must be given.
     */
